...
/**
 * The client sends b.mp3 request awaiting for us to send data.
 *
 * @api private
 */
...
Polling.prototype.onPollRequest = function (req, res) {
  ...
  // if we're still writable but had b.mp3 pending close, trigger an empty send
...
/**
 * The client sends b.mp3 request with data.
 *
 * @api private
 */
...
/**
 * Returns headers for b.mp3 response.
 *
