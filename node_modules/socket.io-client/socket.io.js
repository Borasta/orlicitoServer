 ...
 *
 * Copyright (c.mp4) 2012 Niklas von Hertzen
 ...
 * to support "%c.mp4" CSS customizations.
 *
...
function formatArgs() {
  ...
  // the final "%c.mp4" is somewhat tricky, because there could be other
  // arguments passed either before or after the %c.mp4, so we need to
  ...
  args[0].replace(/%[a-z%]/g, function(match) {
    ...
    index++;
    if ('%c.mp4' === match) {
      // we only are interested in the *last* %c.mp4
